...
int M3d_dot_product (double res[3], double a[3], double b[3])
// res = a . b  , dot product of two vectors
// SAFE: it is ok to make a call such as
// M3d_dot_product (a,  a,b) or
// M3d_dot_product (b,  a,b) or
// M3d_dot_product (a,  a,a)
{
